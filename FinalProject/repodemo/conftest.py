...
from repodemo.histories_project.POM.lib.First_page import Home
from repodemo.histories_project.POM.lib.second_page import Second
...
def get_driver(request, get_browser):
    ...
    request.cls.First_page=Home(driver)
    request.cls.second_page=Second(driver)
